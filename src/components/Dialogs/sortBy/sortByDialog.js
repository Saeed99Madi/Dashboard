  ...
  return (
      ...
      >
        ...
        <RadioGroup
          ...
          <CustomOption label="Higher takeaways" />
          <CustomOption label="Lowest takeaways" />
          <CustomOption label="Created by A-Z" />
          <CustomOption label="Created by Z-A" />
          <CustomOption label="Organization by A-Z" />
          <CustomOption label="Organization by Z-A" />
        </RadioGroup>
      </DialogContent>
